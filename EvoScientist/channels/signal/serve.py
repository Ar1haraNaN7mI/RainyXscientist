...
Usage:
    python -m Rxscientist.channels.signal.serve --phone-number NUMBER [OPTIONS]

Examples:
    # Basic usage
    python -m Rxscientist.channels.signal.serve --phone-number +1234567890

    # With custom signal-cli path and allowed senders
    python -m Rxscientist.channels.signal.serve --phone-number +1234567890 --cli-path /usr/local/bin/signal-cli --allow +9876543210

    # With agent and thinking
    python -m Rxscientist.channels.signal.serve --phone-number +1234567890 --agent --thinking
"""

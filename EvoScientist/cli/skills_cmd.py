"""Slash commands for skill management: /skills, /install-skill, /uninstall-skill, /rxSkills."""
...
def _cmd_install_skill(args: str) -> None:
    ...
    By default, installs to the global skills directory (~/.Rxscientist/skills/).
...
def _cmd_install_skills(args: str = "") -> None:
    """Browse and install skills from the rxSkills repository.

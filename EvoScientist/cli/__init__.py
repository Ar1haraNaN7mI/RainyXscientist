"""Rxscientist CLI package."""

# Backward-compat re-exports (tests import these from Rxscientist.cli)
...
def main():
    ...
    config = load_config()
    _log_level = os.environ.get("Rxscientist_LOG_LEVEL", "") or config.log_level
    _configure_logging()
    app()

...
users with a Claude Pro/Max subscription to use Rxscientist without
...
def _is_editable_install() -> bool:
    """Return True if Rxscientist was installed in editable/development mode.
...
def _oauth_install_hint() -> str:
    ...
    return "pip install 'Rxscientist[oauth]'"
...
def maybe_start_ccproxy(config: RxscientistConfig) -> subprocess.Popen | None:
    ...
    Args:
        config: An ``RxscientistConfig`` instance.

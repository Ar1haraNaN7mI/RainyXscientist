...
class TestLoadingWidget(unittest.TestCase):
    ...
    def test_construction(self):
        from Rxscientist.cli.widgets.loading_widget import LoadingWidget
        from Rxscientist.cli.widgets.timed_status_widget import TimedStatusWidget
    ...
    def test_spinner_frames_not_empty(self):
        from Rxscientist.cli.widgets.loading_widget import _SPINNER_FRAMES
...
class TestCompactingWidget(unittest.TestCase):
    ...
    def test_construction(self):
        from Rxscientist.cli.widgets.compacting_widget import CompactingWidget
...
class TestThinkingWidget(unittest.TestCase):
    ...
    def test_construction_visible(self):
        from Rxscientist.cli.widgets.thinking_widget import ThinkingWidget
...
class TestSummarizationStateMachine(unittest.TestCase):
    ...
    def test_summary_continuation_events_do_not_finalize(self):
        from Rxscientist.cli.tui_interactive import (
...
class TestAssistantMessage(unittest.TestCase):
    ...
    def test_empty_construction(self):
        from Rxscientist.cli.widgets.assistant_message import AssistantMessage
...
class TestToolCallWidget(unittest.TestCase):
    ...
    def test_construction(self):
        from Rxscientist.cli.widgets.tool_call_widget import ToolCallWidget
...
class TestSubAgentWidget(unittest.TestCase):
    ...
    def test_construction(self):
        from Rxscientist.cli.widgets.subagent_widget import SubAgentWidget
...
class TestTodoWidget(unittest.TestCase):
    ...
    def test_construction_empty(self):
        from Rxscientist.cli.widgets.todo_widget import TodoWidget
...
class TestUserMessage(unittest.TestCase):
    ...
    def test_construction(self):
        from Rxscientist.cli.widgets.user_message import UserMessage
...
class TestSystemMessage(unittest.TestCase):
    ...
    def test_construction_default_style(self):
        from Rxscientist.cli.widgets.system_message import SystemMessage
...
class TestIsFinalResponse(unittest.TestCase):
    ...
    def test_empty_state_is_final(self):
        from Rxscientist.cli.tui_interactive import _is_final_response
    ...
    def test_active_subagent_not_final(self):
        from Rxscientist.cli.tui_interactive import _is_final_response
        from Rxscientist.stream.state import StreamState, SubAgentState
...
class TestWidgetImports(unittest.TestCase):
    ...
    def test_all_imports(self):
        from Rxscientist.cli.widgets import (
            AssistantMessage,
            LoadingWidget,
            SubAgentWidget,
            SystemMessage,
...
class TestClipboardPaste(unittest.TestCase):
    ...
    def test_get_clipboard_text_import(self):
        ...
        from Rxscientist.cli.clipboard import get_clipboard_text

        assert callable(get_clipboard_text)

    def test_paste_native_import(self):
        """_paste_native should be importable."""
        from Rxscientist.cli.clipboard import _paste_native
    ...
    def test_get_clipboard_text_with_pyperclip_mock(self):
        ...
        with patch.dict("sys.modules", {"pyperclip": mock_pyperclip}):
            ...
            from Rxscientist.cli import clipboard
...
class TestCompletionLogic(unittest.TestCase):
    ...
    def _make_app(self, comp_items=None, comp_index=-1):
        ...
        from Rxscientist.commands import manager as cmd_manager

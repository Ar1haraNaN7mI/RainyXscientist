...
from Rxscientist.cli.interactive import cmd_interactive
...
def test_cmd_interactive_dispatches_to_textual(monkeypatch):
    ...
    monkeypatch.setattr(
        "Rxscientist.cli.interactive.resolve_ui_backend",
        _fake_resolve_ui_backend,
    )
    monkeypatch.setattr(
        "Rxscientist.cli.interactive.run_textual_interactive",

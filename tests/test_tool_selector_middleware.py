...
from Rxscientist.middleware.tool_selector import (
...
def _factory_patches():
    return (
        patch(
            "Rxscientist.middleware.tool_selector.disable_thinking",
            return_value=MagicMock(),
            create=True,
        ),
        patch("Rxscientist.Rxscientist._ensure_chat_model", return_value=MagicMock()),
        patch(
...
def test_selector_active_flag():
    ...
    import Rxscientist.middleware.tool_selector as ts_mod
...
@patch(
    "Rxscientist.middleware.create_tool_selector_middleware",
...
def test_subagent_no_tool_selector(mock_model):
    ...
    from Rxscientist.Rxscientist import _inject_subagent_middleware

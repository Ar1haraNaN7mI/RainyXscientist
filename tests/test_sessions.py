"""Tests for Rxscientist.sessions — thread CRUD, ID generation, helpers."""
...
class TestThreadFunctions(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        async def _setup():
            ...
            async with aiosqlite.connect(cls._db_path) as conn:
                ...
                # Insert a non-Rxscientist checkpoint (should be filtered)
        ...
        cls._patcher = patch(
            "Rxscientist.sessions.get_db_path",
            return_value=type(
                "P",
                (),
                {
    ...
    def test_list_threads(self):
        ...
        # Should only contain Rxscientist threads
    ...
    def test_delete_thread_preserves_other_agent_writes(self):
        ...
        Rxscientist checkpoints, leaving OtherAgent's writes intact."""
        ...
        # Delete — should only affect Rxscientist's data

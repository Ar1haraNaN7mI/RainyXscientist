...
class TestFeishuChannel:
    ...
    def test_capabilities(self):
        from Rxscientist.channels.capabilities import FEISHU
...
class TestFeishuChannelRegistration:
    def test_feishu_registered(self):
        from Rxscientist.channels.channel_manager import available_channels
...
class TestFeishuProbe:
    def test_missing_app_id(self):
        from Rxscientist.channels.feishu.probe import validate_feishu_credentials

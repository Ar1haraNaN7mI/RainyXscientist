"""Tests for Rxscientist.stream.diff_format module."""
...
from Rxscientist.stream.diff_format import (
...
class TestFormatToolResultCompactEditFile:
    def test_edit_file_with_tool_args_shows_diff(self):
        from Rxscientist.stream.display import format_tool_result_compact

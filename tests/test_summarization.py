...
from Rxscientist.stream.events import _extract_summarization_text
...
class TestSummarizationRichDisplay:
    ...
    def test_no_panel_when_empty(self):
        from Rxscientist.stream.display import create_streaming_display
...
class TestSummarizationWidget:
    ...
    def test_init_collapsed(self):
        from Rxscientist.cli.widgets.summarization_widget import SummarizationWidget
...
class TestCompactSummaryWidget:
    ...
    def test_init_collapsed(self):
        from Rxscientist.cli.widgets.compact_summary_widget import CompactSummaryWidget

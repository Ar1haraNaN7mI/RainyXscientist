...
class TestMatchesShellAllowList:
    def test_matches_prefix(self):
        from Rxscientist.stream.display import _matches_shell_allow_list
...
class TestResolveHitlApproval:
    ...
    def test_config_auto_approve(self):
        ...
        try:
            ...
            with patch(
                "Rxscientist.config.settings.load_config", return_value=mock_cfg
            ):
    ...
    def test_execute_not_in_allow_list_prompts(self):
        ...
        try:
            ...
            with patch(
                ...
                with patch(
                    "Rxscientist.stream.display._prompt_hitl_approval"
                ) as mock_prompt:
...
class TestHitlConfig:
    ...
    def test_auto_approve_set(self):
        ...
        cfg = RxscientistConfig(auto_approve=True)
    ...
    def test_shell_allow_list_set(self):
        ...
        cfg = RxscientistConfig(shell_allow_list="ls,cat,python")
...
class TestConsumerHitlHelpers:
    def test_parse_approval_approve(self):
        from Rxscientist.channels.consumer import _parse_approval_reply
    ...
    def test_format_approval_prompt(self):
        from Rxscientist.channels.consumer import _format_approval_prompt
    ...
    def test_should_auto_approve_non_execute(self):
        from Rxscientist.channels.consumer import _should_auto_approve
    ...
    def test_should_auto_approve_execute_no_allowlist(self):
        ...
        mock_cfg.auto_approve = False
        mock_cfg.shell_allow_list = ""
        with patch("Rxscientist.config.settings.load_config", return_value=mock_cfg):
...
class TestChannelHitlIntercept:
    ...
    def test_try_set_hitl_reply_no_pending(self):
        from Rxscientist.cli.channel import _try_set_hitl_reply
    ...
    def test_pop_hitl_reply_no_pending(self):
        from Rxscientist.cli.channel import _pop_hitl_reply

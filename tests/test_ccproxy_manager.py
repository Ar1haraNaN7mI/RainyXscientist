...
class TestStartCcproxy:
    @patch("Rxscientist.ccproxy_manager.is_ccproxy_running")
    ...
    @patch("Rxscientist.ccproxy_manager.is_ccproxy_running", return_value=False)
    @patch("Rxscientist.ccproxy_manager.time")
    @patch("subprocess.Popen")
...
class TestEnsureCcproxy:
    @patch("Rxscientist.ccproxy_manager.is_ccproxy_running", return_value=True)
    def test_already_running(self, mock_running):
        result = ensure_ccproxy(8000)
        assert result is None

    @patch("Rxscientist.ccproxy_manager.start_ccproxy")
    @patch("Rxscientist.ccproxy_manager.is_ccproxy_running", return_value=False)
...
class TestMaybeStartCcproxy:
    ...
    @patch("Rxscientist.ccproxy_manager.setup_ccproxy_env")
    @patch("Rxscientist.ccproxy_manager.ensure_ccproxy")
    @patch("Rxscientist.ccproxy_manager.check_ccproxy_auth", return_value=(True, "OK"))
    @patch("Rxscientist.ccproxy_manager.is_ccproxy_available", return_value=True)
    ...
    @patch("Rxscientist.ccproxy_manager.is_ccproxy_available", return_value=False)
    ...
    @patch(
        "Rxscientist.ccproxy_manager.check_ccproxy_auth",
    ...
    @patch("Rxscientist.ccproxy_manager.setup_codex_env")
    @patch("Rxscientist.ccproxy_manager.ensure_ccproxy")
    @patch("Rxscientist.ccproxy_manager.check_ccproxy_auth", return_value=(True, "OK"))
    @patch("Rxscientist.ccproxy_manager.is_ccproxy_available", return_value=True)
    ...
    @patch("Rxscientist.ccproxy_manager._is_editable_install", return_value=True)
    @patch("Rxscientist.ccproxy_manager.is_ccproxy_available", return_value=False)
    ...
    @patch("Rxscientist.ccproxy_manager._is_editable_install", return_value=False)
    @patch("Rxscientist.ccproxy_manager.is_ccproxy_available", return_value=False)
    def test_openai_oauth_raises_no_binary_pip(self, mock_avail, mock_edit):
        ...
        msg = str(exc_info.value)
        assert "ccproxy is required for OAuth mode but not found" in msg
        assert "pip install 'Rxscientist[oauth]'" in msg

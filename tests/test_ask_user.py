...
class TestDataTypes:
    ...
    def test_choice_construction(self):
        from Rxscientist.middleware.ask_user import Choice

        choice: Choice = {"value": "CIFAR-10"}
        assert choice["value"] == "CIFAR-10"

    def test_question_text_construction(self):
        from Rxscientist.middleware.ask_user import Question
    ...
    def test_ask_user_request_construction(self):
        from Rxscientist.middleware.ask_user import AskUserRequest
    ...
    def test_ask_user_answered_construction(self):
        from Rxscientist.middleware.ask_user import AskUserAnswered
    ...
    def test_ask_user_cancelled_construction(self):
        from Rxscientist.middleware.ask_user import AskUserCancelled
...
class TestCoerceQuestionsList:
    ...
    def test_json_string_parsed_to_list(self):
        from Rxscientist.middleware.ask_user import _coerce_questions_list
...
class TestValidateQuestions:
    ...
    def test_empty_list_raises(self):
        from Rxscientist.middleware.ask_user import _validate_questions
...
class TestParseAnswers:
    ...
    def test_answered_status(self):
        from Rxscientist.middleware.ask_user import _parse_answers
...
class TestAskUserMiddleware:
    ...
    def test_init_creates_tool(self):
        from Rxscientist.middleware.ask_user import AskUserMiddleware
    ...
    def test_system_prompt_set(self):
        from Rxscientist.middleware.ask_user import (
    ...
    def test_system_prompt_mentions_resource_estimation(self):
        from Rxscientist.middleware.ask_user import ASK_USER_SYSTEM_PROMPT
    ...
    def test_tool_description_mentions_resource(self):
        from Rxscientist.middleware.ask_user import ASK_USER_TOOL_DESCRIPTION
...
class TestStreamEmitter:
    ...
    def test_ask_user_interrupt_event_structure(self):
        from Rxscientist.stream.emitter import StreamEventEmitter
...
class TestStreamState:
    ...
    def test_pending_ask_user_starts_none(self):
        from Rxscientist.stream.state import StreamState
...
class TestConfig:
    ...
    def test_default_is_true(self):
        from Rxscientist.config.settings import RxscientistConfig

        cfg = RxscientistConfig()
        assert cfg.enable_ask_user is True

    def test_set_to_false(self):
        from Rxscientist.config.settings import RxscientistConfig

        cfg = RxscientistConfig(enable_ask_user=False)
    ...
    def test_auto_mode_set_to_true(self):
        ...
        cfg = RxscientistConfig(auto_mode=True)
        assert cfg.auto_mode is True


@patch("Rxscientist.middleware.create_tool_selector_middleware", return_value=[])
@patch("Rxscientist.Rxscientist._ensure_chat_model")
@patch("Rxscientist.Rxscientist._ensure_config")
def test_auto_approve_still_includes_ask_user_middleware(
    ...
    from Rxscientist.Rxscientist import _get_default_middleware
...
class TestRichCLIPrompt:
    ...
    def test_text_question_returns_answered(self):
        ...
        from Rxscientist.stream.display import _resolve_ask_user_prompt
...
class TestAskUserWidget:
    ...
    def test_widget_instantiation(self):
        from Rxscientist.cli.widgets.ask_user_widget import AskUserWidget
...
class TestMiddlewareExports:
    ...
    def test_ask_user_middleware_exported(self):
        from Rxscientist.middleware import AskUserMiddleware

        assert AskUserMiddleware is not None

    def test_ask_user_request_exported(self):
        from Rxscientist.middleware import AskUserRequest

        assert AskUserRequest is not None

    def test_question_exported(self):
        from Rxscientist.middleware import Question

        assert Question is not None

    def test_choice_exported(self):
        from Rxscientist.middleware import Choice

        assert Choice is not None

    def test_widget_result_exported(self):
        from Rxscientist.middleware import AskUserWidgetResult

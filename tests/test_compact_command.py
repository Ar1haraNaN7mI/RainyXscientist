...
class TestCompactCutoffZero:
    ...
    def test_nothing_to_compact_short_conversation(self):
        ...
        with (
            patch("Rxscientist.Rxscientist._ensure_chat_model", return_value=model),
            patch(
                "Rxscientist.Rxscientist._get_default_backend",
...
class TestRenderCompactResult:
    ...
    def test_render_noop(self):
        from Rxscientist.cli.commands import CompactResult, render_compact_result
...
class TestCompactCommandUI:
    ...
    def test_command_uses_tui_indicator_when_available(self):
        from Rxscientist.cli.commands import CompactResult
        from Rxscientist.commands.base import CommandContext
        from Rxscientist.commands.implementation.session import CompactCommand
        ...
        with (
            patch(
                "Rxscientist.cli.commands.compact_conversation",
                AsyncMock(return_value=result),
            ),
            patch(
                "Rxscientist.cli.commands.render_compact_result",
                return_value="result-panel",
            ),
            patch(
                "Rxscientist.cli.commands.build_compact_summary_renderable",
    ...
    def test_build_compact_summary_renderable(self):
        from Rxscientist.cli.commands import (
            CompactResult,

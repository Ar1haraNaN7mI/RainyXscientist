"""Tests for Rxscientist LLM module."""
...
from Rxscientist.llm.models import _MODEL_ENTRIES
...
class TestGetChatModel:
    @patch("Rxscientist.llm.models.init_chat_model")
...
class TestThirdPartyRouting:
    ...
    def test_openrouter_reasoning_effort_from_env(self, mock_init, monkeypatch):
        ...
        mock_init.return_value = "mock_model"
        monkeypatch.setenv("OPENROUTER_API_KEY", "or-key")
        monkeypatch.setenv("Rxscientist_REASONING_EFFORT", "medium")
...
class TestMiniMaxProvider:
    def test_minimax_in_anthropic_routed_providers(self):
        ...
        from Rxscientist.llm.models import _ANTHROPIC_ROUTED_PROVIDERS
    ...
    def test_minimax_not_in_openai_routed_providers(self):
        ...
        from Rxscientist.llm.models import _OPENAI_ROUTED_PROVIDERS
...
class TestFlattenMessageContent:
    ...
    def test_string_passthrough(self):
        from Rxscientist.llm.patches import _flatten_message_content
...
class TestAutoConfig:
    ...
    def test_use_responses_api_false(self, mock_init, monkeypatch):
        ...
        mock_init.return_value = "mock_model"
        monkeypatch.delenv("OPENAI_BASE_URL", raising=False)
        monkeypatch.setenv("Rxscientist_USE_RESPONSES_API", "false")
    ...
    def test_use_responses_api_true(self, mock_init, monkeypatch):
        ...
        mock_init.return_value = "mock_model"
        monkeypatch.delenv("OPENAI_BASE_URL", raising=False)
        monkeypatch.setenv("Rxscientist_USE_RESPONSES_API", "true")
    ...
    def test_use_responses_api_default_unchanged(self, mock_init, monkeypatch):
        ...
        mock_init.return_value = "mock_model"
        monkeypatch.delenv("OPENAI_BASE_URL", raising=False)
        monkeypatch.delenv("Rxscientist_USE_RESPONSES_API", raising=False)
    ...
    def test_use_responses_api_false_normalization(
        ...
        mock_init.return_value = "mock_model"
        monkeypatch.delenv("OPENAI_BASE_URL", raising=False)
        monkeypatch.setenv("Rxscientist_USE_RESPONSES_API", env_value)

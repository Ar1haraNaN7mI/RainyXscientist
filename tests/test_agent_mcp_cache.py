"""Tests for MCP tool caching in Rxscientist.Rxscientist."""

from __future__ import annotations

import Rxscientist.Rxscientist as agent_module
...
class TestMcpToolCaching:
    ...
    def test_reuses_cached_tools_when_config_unchanged(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "Rxscientist.mcp.client.load_mcp_config",
        ...
        monkeypatch.setattr("Rxscientist.mcp.load_mcp_tools", fake_load_mcp_tools)
    ...
    def test_reload_when_config_changes(self, monkeypatch):
        ...
        monkeypatch.setattr("Rxscientist.mcp.client.load_mcp_config", fake_load_config)
        monkeypatch.setattr("Rxscientist.mcp.load_mcp_tools", fake_load_mcp_tools)
    ...
    def test_load_mcp_config_called_once_per_cache_miss(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "Rxscientist.mcp.client.load_mcp_config", counting_load_config
        )
        monkeypatch.setattr(
            "Rxscientist.mcp.load_mcp_tools", lambda config=None: {"main": []}
        )

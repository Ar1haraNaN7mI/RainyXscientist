"""Rxscientist Agent - AI-powered research and code execution.
...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "Rxscientist_agent": (".Rxscientist", "Rxscientist_agent"),
    "create_cli_agent": (".Rxscientist", "create_cli_agent"),
    # Backends
    "CustomSandboxBackend": (".backends", "CustomSandboxBackend"),
    "ReadOnlyFilesystemBackend": (".backends", "ReadOnlyFilesystemBackend"),
    # Configuration
    "RxscientistConfig": (".config", "RxscientistConfig"),

...
def cmd_interactive(
    ...
    async def _async_main_loop():
        ...
        async with get_checkpointer() as checkpointer:
            ...
            console.print(
                Text(
                    "  Rxscientist is your research buddy.\n"
                    ...
                    if available:
                        ...
                        console.print(
                            Text(
                                ...
                                "  Run: uv tool upgrade Rxscientist",
                                style="yellow",
                            )
                        )
                except Exception:
            ...
            try:
                ...
                while state["running"]:
                    try:
                        ...
                        if user_input.lower().startswith("/rxSkills"):
                            browse_args = user_input[len("/rxSkills") :].strip()

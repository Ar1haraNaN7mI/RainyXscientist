"""LLMToolSelectorMiddleware configuration for Rxscientist.
...
Usage::
    ...
    from Rxscientist.middleware import create_tool_selector_middleware
...
def create_tool_selector_middleware(
    ...
    *,
    ...
    """Build LLMToolSelectorMiddleware + tracker with Rxscientist defaults.

"""ContextEditingMiddleware configuration for Rxscientist.
...
Usage::
    ...
    from Rxscientist.middleware import create_context_editing_middleware
...
def create_context_editing_middleware(model: BaseChatModel | None = None):
    """Build a ContextEditingMiddleware with Rxscientist defaults.

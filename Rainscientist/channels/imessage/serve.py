...
Usage:
    python -m Rxscientist.channels.imessage.serve [OPTIONS]

Examples:
    # Allow all senders (default)
    python -m Rxscientist.channels.imessage.serve

    # Only allow specific senders
    python -m Rxscientist.channels.imessage.serve --allow +1234567890 --allow user@example.com

    # Custom imsg path
    python -m Rxscientist.channels.imessage.serve --cli-path /usr/local/bin/imsg
"""

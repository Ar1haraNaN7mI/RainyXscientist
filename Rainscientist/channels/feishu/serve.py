...
Usage:
    python -m Rxscientist.channels.feishu.serve --app-id ID --app-secret SECRET [OPTIONS]

Examples:
    # Basic setup
    python -m Rxscientist.channels.feishu.serve --app-id ID --app-secret SECRET
    ...
    python -m Rxscientist.channels.feishu.serve --app-id ID --app-secret SECRET --agent --thinking
"""

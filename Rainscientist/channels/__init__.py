"""Communication channels for Rxscientist.

This module provides an extensible interface for different messaging channels
(iMessage, Telegram, Discord, Slack, WeChat, DingTalk, Feishu, Email, QQ, Signal) to communicate with the Rxscientist agent.
"""

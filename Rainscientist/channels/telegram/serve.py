...
Usage:
    python -m Rxscientist.channels.telegram.serve --bot-token TOKEN [OPTIONS]

Examples:
    # Allow all senders (default)
    python -m Rxscientist.channels.telegram.serve --bot-token TOKEN

    # Only allow specific senders
    python -m Rxscientist.channels.telegram.serve --bot-token TOKEN --allow 123456 --allow 789012

    # With agent and thinking
    python -m Rxscientist.channels.telegram.serve --bot-token TOKEN --agent --thinking
"""

...
Usage:
    python -m Rxscientist.channels.dingtalk.serve --client-id ID --client-secret SECRET [OPTIONS]

Examples:
    # Basic usage
    python -m Rxscientist.channels.dingtalk.serve --client-id ID --client-secret SECRET

    # With proxy and allowed senders
    python -m Rxscientist.channels.dingtalk.serve --client-id ID --client-secret SECRET --proxy http://proxy:8080 --allow user123

    # With agent and thinking
    python -m Rxscientist.channels.dingtalk.serve --client-id ID --client-secret SECRET --agent --thinking
"""

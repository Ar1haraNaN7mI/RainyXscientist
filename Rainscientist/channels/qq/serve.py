...
Usage:
    python -m Rxscientist.channels.qq.serve --app-id ID --app-secret SECRET [OPTIONS]

Examples:
    # Basic usage
    python -m Rxscientist.channels.qq.serve --app-id ID --app-secret SECRET

    # Sandbox mode with allowed senders
    python -m Rxscientist.channels.qq.serve --app-id ID --app-secret SECRET --allow user123

    # With agent and thinking
    python -m Rxscientist.channels.qq.serve --app-id ID --app-secret SECRET --agent --thinking
"""

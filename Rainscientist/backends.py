"""Custom backends for Rxscientist agent."""
...
class MergedSkillsBackend(BackendProtocol):
    ...
    2. global    — ~/.Rxscientist/skills/  (user global, read-only)
    3. secondary — Rxscientist/skills/  (built-in, PyPI, read-only)
...
class CustomSandboxBackend(LocalShellBackend):
    ...
    def __init__(
        ...
        *,
        ...
        self._sandbox_id = f"rxsci-{uuid.uuid4().hex[:8]}"
